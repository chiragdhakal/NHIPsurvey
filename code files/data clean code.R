...
section6c1 <- section6c1 %>%
  mutate(
    disease_id = paste0(personid, "-", v630),
    v632 = if_else(
      disease_id == "19491-6", 1, v632
    ),
    v631a = if_else(
      disease_id == "19491-6", "", v631a
    ),
    v631b = if_else(
      disease_id == "19491-6", "", v631b
    ),
    v635 = if_else(
      disease_id == "19491-6", "", v635
    ), 
    v636 = if_else(
      disease_id == "19491-6", 1, v636
    ),
    v639a = if_else(
      disease_id == "19491-6", "", v639a
    )
  )
...
section6c2 <- section6c2 %>%
  mutate(
    v642 = case_when(
      disease_id == "56148-11" ~ "10", 
      disease_id == "56148-13" ~ "10,7", 
      TRUE ~ v642
    ), 
    v643 = case_when(
      disease_id == "39395-11" ~ 2, 
      disease_id == "39395-14" ~ 1, 
      TRUE ~ v643
    ),
    v645 = case_when(
      disease_id == "39395-11" ~ "", 
      disease_id == "39395-14" ~ "4", 
      TRUE ~ v645
    )
  )
...
rm(s6c1_add, s6c2_add, s6c3_missing, s6c4_missing, ssf_respondent_id, s6b3_update, s6b4_updates)
